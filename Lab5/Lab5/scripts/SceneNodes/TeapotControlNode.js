...
function InitTeapotControlNode()
   ...
   for( var row = 0; row < gTeapotControlNode.TeapotPerLine; ++row )
      ...
      for( var col = 0; col < gTeapotControlNode.TeapotPerLine; ++col )
         ...
         teapot.MaterialAmbient= vec4.fromValues( 0.01, 0.01, 0.01, 1.0 );
         teapot.MaterialDiffuse = vec4.fromValues( 0.1, 0.1, 0.1, 1.0 );
         teapot.MaterialSpecular = vec4.fromValues( 0.1, 0.1, 0.1, 1.0 );
